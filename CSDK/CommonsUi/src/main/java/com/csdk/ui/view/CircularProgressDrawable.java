...
import com.csdk.androidx.FastOutSlowInInterpolator;
...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public CircularProgressDrawable(@NonNull Context context) {
        mResources = null!=context?context.getResources():null;
    ...
    private void setSizeParameters(float centerRadius, float strokeWidth, float arrowWidth,
        ...
        final DisplayMetrics metrics = null!=mResources?mResources.getDisplayMetrics():null;
        final float screenDensity = null!=metrics?metrics.density:-1;
