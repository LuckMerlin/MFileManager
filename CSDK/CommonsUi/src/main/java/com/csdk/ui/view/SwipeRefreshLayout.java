 ...
 * TODO
 */
public final class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    public boolean setCircleAlpha(float alpha){
        if (mCircleAlpha!=alpha){
            mCircleAlpha=alpha;
            View view=mCircleView;
            if (null!=view){
                view.setAlpha(alpha);
            }
            return true;
    ...
    private void createProgressView() {
        ...
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        mCircleView.setAlpha(mCircleAlpha);
        addView(mCircleView);
    }
