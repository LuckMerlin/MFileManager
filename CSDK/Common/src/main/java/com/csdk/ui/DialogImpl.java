...
public final class DialogImpl {
    ...
    public DialogImpl(Context context, boolean enableEdge){
        this(context,enableEdge,true);
    }

    public DialogImpl(Context context, boolean enableEdge, boolean hideBottomNavigation){
    ...
    public DialogImpl setSoftInputMode(int softInputMode){
    ...
    public DialogImpl setFlags(int flags, int mask){
        Window window=getWindow();
        if (null!=window){
    ...
    public final DialogImpl setContentView(Model model){
        return setContentView(model,null,null);
    }

    public final DialogImpl setContentView(Model model, Integer width, Integer height){
        if (null!=model) {
            View view=getRoot();
    ...
    public final DialogImpl setDimAmount(float dim){
    ...
    public final DialogImpl setCanceledOnTouchOutside(boolean cancel){
        android.app.Dialog dialog=mDialog;
        if (null!=dialog){
    ...
    public final DialogImpl setCancelable(boolean flag){
        android.app.Dialog dialog=mDialog;
        if (null!=dialog){
    ...
    public final DialogImpl setOnDismissListener(DialogInterface.OnDismissListener dismissListener){
        android.app.Dialog dialog=mDialog;
        if (null!=dialog){
    ...
    public final DialogImpl setContentView(int layoutId){
        return setContentView(layoutId,null,null);
    }

    public final DialogImpl setContentView(int layoutId, Integer width, Integer height){
        android.app.Dialog dialog=mDialog;
    ...
    public final DialogImpl setContentView(View view){
        return setContentView(view, null,null);
    }

    public final DialogImpl setContentView(View view, Integer width, Integer height){
    ...
    public final DialogImpl setGravity(int gravity){
        Window window=getWindow();
        if (null!=window){
